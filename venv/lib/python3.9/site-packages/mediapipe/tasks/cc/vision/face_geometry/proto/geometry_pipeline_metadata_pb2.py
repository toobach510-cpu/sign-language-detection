...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\n)mediapipe.tasks.vision.facegeometry.protoB\035GeometryPipelineMetadataProto'
